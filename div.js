...
function commandPrompt(){
  ...
  test.innerHTML="</br>blackHat@hacker:-<input id='command' type='text'/><input id='go' type='button'value='Go' onclick='getCommand()'/></br></br>";
}
...
////////////////////////////////////
function clear(){
  main.innerHTML="blackHat@hacker:-<input id='command' type='text'/><input id='go' type='button'value='Go' onclick='getCommand()'/></br></br>";
}
